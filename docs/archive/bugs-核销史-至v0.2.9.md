# 活跃缺陷台账 · 核销史归档（至 v0.2.9）

> 2026-08-23 随 v0.2.10 发版从 `docs/current/bugs.md` 整体移入（评审「流程安排」③纪律：已发版批次的核心销节随版归档，current 台账只回答「现在有什么没修」，过程留 git）。冻结件，不再改写；其后批次的核销见彼时归档件。

...
- `npm run check` / `npm test`(965 用例:core 240 + domain 347 + shell 378;另 cargo test 17;写作闭环 e2e-workflow 12 步含碰撞闸门与触发式续写,真实 LLM key 在场才跑;GitHub Actions CI 门禁同口径)
